...
- Pembagian Data Latih dan Uji (Data Splitting): Dengan proporsi test_size=0.2 pada 5 sampel data, diperoleh pembagian 4 data untuk pelatihan (X_train) dan 1 data untuk pengujian (X_test).
